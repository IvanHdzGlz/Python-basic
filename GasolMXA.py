...
#paleta de colores
#colores = plt.cm.tab20c(range(20))
colores = {'aqua','red','white','bisque','lime','sienna',
           'violet','plum','purple','gold','azure',
           'tan','coral','hotpink','blue','royalblue',
           'crimson','beige','teal','dodgerblue','chartreuse',
           'yellow','steelblue','wheat','springgreen','fuchsia','deeppink',
           'magenta','indigo','turquoise','olive','orangered'}
...
def dibujar_grafica(i):
    ...
    y = df_rank_ext.iloc[i]
    width = df_exten.iloc[i]
    ax.barh(y=y, width=width, color=colores, tick_label=etiquetas)
